# Kim-PE-Data
This repository contains the PE deal dataset produced in **Kim, S., et al. (2026).** *A Practitioner’s Guide to Using Data on Private Equity Hospital Acquisitions*. Health Affairs Scholar. [Paper Link](https://doi.org/10.1093/haschl/qxag071)

This data is also used in **Naslund, M., et al. (2026).** *Three Facts about Private Equity in the U.S. Hospital Sector*. Health Affairs Scholar. [Paper Link](https://doi.org/10.1093/haschl/qxag217)
...
May 18, 2026 - Corrected CMS ID linkage for three hospitals, new hospital IDs generated:
 ...
 H-557 Hillcrest Hospital Henryetta,
  and H-558 Hillcrest Hospital Claremore.
...
these hospitals are separate units and not duplicate rows. New hospital IDs generated:
 ...
 H-554-A Metropolitan Methodist Hosp, and
